    ...
    productos: [
      {
        ...
        nombre: "Olaplex Nº7 Bonding Oil - Aceite Capilar Concentrado",
        imagen: "/imagenes/olaplex.jpg",
        precioCop: 129900,
        descripcion:
          "Aceite capilar ultraligero y concentrado que transforma el cabello al instante. Con su tecnología Bond Building Technology® y una mezcla de aceites naturales (girasol, moringa, granada, té verde y semilla de uva), repara y protege dejándolo más sano y brillante.\n\nAporta hasta un 125% más de brillo, realza el color y fortalece el cabello reduciendo la rotura hasta un 77%. Controla el encrespamiento durante 72 horas y ofrece protección térmica frente al calor de planchas y secadores (hasta 232 °C).\n\nUn imprescindible para un cabello protegido, reparado y con un acabado impecable.",
      },
      {
        id: "kerastase-nutritive-night-serum",
        nombre: "Kérastase K Nutritive 8h Magic Night Serum",
        imagen: "/imagenes/kerastase.jpg",
        precioCop: 149900,
        descripcion:
          "Sérum capilar nocturno que hidrata y suaviza el cabello seco mientras duermes, sin dejar sensación pesada. Un tratamiento sin aclarado que actúa durante unas 8 horas para que despiertes con un cabello más nutrido y manejable.\n\nSu textura ligera se integra fácilmente en la rutina nocturna sin dejar el cabello rígido ni apelmazado, algo especialmente valorado en cabellos secos o sensibilizados.\n\nUso: aplicar antes de dormir sobre medios y puntas, según necesidad. Ideal para cabello seco, apagado o con frizz.",
      },
      {
        id: "moroccanoil-tratamiento-spray",
        nombre: "Tratamiento Moroccanoil en Spray",
        imagen: "/imagenes/moroccanoil.webp",
        precioCop: 119900,
        descripcion:
          "Spray ultraligero con aceite de argán que se absorbe al instante, aportando brillo, suavidad y control del encrespamiento.\n\nHidrata y acondiciona en profundidad, dejando el cabello con una ligereza aireada y un acabado sedoso.",
      },
    ],
  },
  {
